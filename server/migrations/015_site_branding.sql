...
INSERT INTO system_config (key, value, updated_at) VALUES
  ('site_name',    'AI-Portal', CURRENT_TIMESTAMP),
...
INSERT INTO system_config (key, value, updated_at) VALUES
  ...
  ('banner_html',
$$欢迎使用 <span class="banner-emphasis">1Panel AI Portal</span> —— 企业 AI 自助门户，探索模型、申请密钥、安装技能，一站式开启 AI 之旅。$$,
   CURRENT_TIMESTAMP)
ON CONFLICT (key) DO NOTHING;
...
INSERT INTO system_config (key, value, updated_at) VALUES
  ...
  ('dialog_title',   '欢迎使用 AI-Portal',     CURRENT_TIMESTAMP),
  ('dialog_html',
$$<p>欢迎来到 <strong>AI-Portal</strong> —— 企业 AI 自助门户。</p>
<p>在这里你可以：</p>
<ul>
